...
public class UserInfoService {
	...
	public UserInfo findByUserNameAndPasswordAndEnabled(String userName, String password) {
		short enabled1 = 1;
		return userDatailsRepository.findByUserNameAndPasswordAndEnabled(userName,password, enabled1);
	}
	...
	public UserInfo getUserInfoById(Integer id) {
		Optional<UserInfo> optional = userDatailsRepository.findById(id);
		return optional.get();
